.. _db-world-dbscripts-on-creature-death:

======================================
"dbscripts\_on\_creature\_death" table
======================================

The ``dbscripts_on_creature_death`` table holds scripts which are
executed upon a creature's death.
