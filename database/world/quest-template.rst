...
Value \| Description ------ \| -----------
:math:`B     | Line break `\ N \| Character name
:math:`R     | Character race `\ C \| Character class
:math:`G m:f | Inserts string based on character gender. Example: `Such a generous `\ G
man:woman\`. The order male:female needs to be kept.
