.. _db-world-reference-loot-template:

=================================
"reference\_loot\_template" table
=================================

The ``reference_loot_template`` table holds definitions for item loot,
which can be reference by other loot templates.
...
The unique identifer for the reference loot template. This is referenced
by any of the specific loot templates.
