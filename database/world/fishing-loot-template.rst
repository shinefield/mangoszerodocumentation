.. _db-world-fishing-loot-template:

===============================
"fishing\_loot\_template" table
===============================

The ``fishing_loot_template`` table holds definitions on items dropped
by fishing in specific zones.
...
*Notice*: junk loot to be distributed when fishing with low skill in a
