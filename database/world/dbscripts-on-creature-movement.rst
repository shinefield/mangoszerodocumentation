.. _db-world-dbscripts-on-creature-movement:

=========================================
"dbscripts\_on\_creature\_movement" table
=========================================

The ``dbscripts_on_creature_movement`` table holds holds scripts which
are executed upon creature movement.
...
`creature\_movement <creature_movement>`__ table.
